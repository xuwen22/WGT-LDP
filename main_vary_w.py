...
def main_vary_w(data_path, eps, e_r, exp_num, delta=1.0):
    # error vary window
    ...
    for wi in w:
        ...
        for exper in range(exp_num):
            print('-----------window=%.1f,exper=%d/%d-------------' % (wi, exper + 1, exp_num))
            prev_matrix = 0
            sample_snapshot = defaultdict(list)
            ...
            for time_index in range(snapshot_num):
                ...
                path = Path(data_path)
                if 'synthetic_data' in path.parts:
                    mat0, mid = utils.get_mat_Synthetic(data_path, node_num, time_index)
                else:
                ...
                if time_index == 0:
                    ...
                    p_2 = 1 - np.exp(- (node_num /(wi * presample_number)))
                    ...
                    if time_index < wi:
                        ...
                        nosamp_node = nosample_snapshot[time_index - 1] + sample_snapshot[time_index - wi + 1]
                ...
                mat2_seq = mat2.ravel()[np.flatnonzero(mat2_triu)]
                ...
                #dataset_name = "tech"
                #utils.save_graph_with_params_window(dataset_name, wi, time_index, exper, syn_mat, mid, type="main_vary_w")
...
if __name__ == '__main__':
    ######### Real Dataset
    # dataset: Email-Eu
    # data_path = "./real_data/EmailDept1_LDP/EmailDept1"
    # node_num = 319
    # snapshot_num = 173
    # max_h = 72

    # dataset: Forum
    data_path = "./real_data/Forum_LDP/FbForum"
    node_num = 899
    snapshot_num = 24
    max_h = 168

    # dataset: Tech-AS
    # data_path = "./real_data/Tech_LDP/tech"
    # node_num = 5000
    # snapshot_num = 24
    # max_h = 24
    ...
    ######### Synthetic Dataset
    # dataset: Synthetic-I
    # data_path = "./synthetic_data/data_1wnodes_2/newsnapshot"
    # node_num = 10000
    # snapshot_num = 100
    # max_h = 200

    # dataset: Synthetic-II
    # data_path = "./synthetic_data/data_1wnodes_9/newsnapshot"
    # node_num = 10000
    # snapshot_num = 100
    # max_h = 200
    ...
    ######### set the sliding window size, list type
    w = [3, 6, 9, 12, 15]

    ######### run the function
    main_vary_w(data_path, eps, e_r, exp_num, delta=1.0)